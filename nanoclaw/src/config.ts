...
export const DEFAULT_PROVIDER =
  process.env.OPENCODE_PROVIDER || envConfig.OPENCODE_PROVIDER || 'anthropic';
export const DEFAULT_MODEL =
  process.env.OPENCODE_MODEL || envConfig.OPENCODE_MODEL || 'claude-sonnet-4-20250514';

export const CONTAINER_IMAGE =
  process.env.CONTAINER_IMAGE || 'nanoclaw-opencode-agent:latest';
